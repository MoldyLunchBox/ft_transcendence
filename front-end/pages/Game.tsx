...
export default function Game() {
  ...
  useEffect(() => {
    ...
    log("this is the query", room)

      const MatterNode = new MatterJsModules(`${room}`, context?.socket)
      setMatterjsInstance(MatterNode)
      MatterNode.roomOwnerListen(setOwnerLeft)
  ...
  return (
    <>
      ...
      <main>
        ...
        {isModalOpen && <ModalGame isOpen={isModalOpen} closeModal={closeModal} title={ownerLeft ? "GAMEOVER" : "WINNER"} msg={ownerLeft ? "Owner left the game..." : winner} color='bg-white' />}
