...
interface setOwnerLeft {
    (ownerLeft: boolean): void;
...
export class MatterJsModules {
    ...
    // solids : solidBodies
    constructor(roomId: string | string[] | undefined, socket: Socket | undefined) {
    ...
    roomOwnerListen(setOwnerLeft: setOwnerLeft) {
        this.socket?.on('ownerLeft', (data) => {
